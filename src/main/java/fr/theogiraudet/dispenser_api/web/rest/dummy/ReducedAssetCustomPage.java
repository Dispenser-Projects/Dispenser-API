 ...
 */
@Schema(name = "Asset Page", description = "A Page of asset data")
public class ReducedAssetCustomPage extends CustomPage<ReducedAsset> {
    /**
     ...
     */
    public <U> ReducedAssetCustomPage(long count, int limit, int offset, Sort sort, List<ReducedAsset> elements, Class<U> controller, Function<U, Object> pointTo) {
