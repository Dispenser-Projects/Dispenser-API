...
import fr.theogiraudet.minecraft_data.web.rest.BlockMcMetaController;
import fr.theogiraudet.minecraft_data.web.rest.BlockModelController;
import fr.theogiraudet.minecraft_data.web.rest.BlockTextureController;
...
public enum MinecraftAsset implements MinecraftResource {
    ...
    public static List<MinecraftAsset> getAll() {
        return List.of(BLOCK_TEXTURE, BLOCK_TEXTURE_MCMETA, BLOCK_MODEL);
    }
}
